...
import memphis.myapplication.MemoryCache;
    ...
    public static final OnInterestCallback onDataInterest = new OnInterestCallback() {
        ...
        public void onInterest(Name prefix, Interest interest, Face face, long interestFilterId,
            ...
            try {
                ...
                String filename = m_seqToFileName.get(m_producer.getSeqNo(producerPrefix + "/data")).toString();
                data.setContent(new Blob(filename));
                face.putData(data);
